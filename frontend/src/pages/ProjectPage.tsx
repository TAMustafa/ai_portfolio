...
export default function ProjectPage() {
    ...
    return (
      <div className="bg-paper text-ink h-screen overflow-y-auto pt-20">
        <div className="container mx-auto px-4 py-8">
          ...
          <Link to="/" className="text-indigo-700 hover:underline">← Home</Link>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="bg-paper text-ink h-screen overflow-y-auto pt-20">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-ink-muted mb-8">We couldn't find a page for "{slug}" in language "{lang}".</p>
          <Link to="/" className="text-indigo-700 hover:underline">← Home</Link>
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-paper text-ink h-screen overflow-y-auto pt-20">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <Link to={`/${effectiveLang}`} className="inline-flex items-center text-indigo-700 hover:text-indigo-900 transition-colors">
        ...
        <React.Suspense fallback={<div className="text-gray-400">Loading…</div>}>
          <MDXProvider
            components={{
              ...
              a: (props) => <a className="text-indigo-700 hover:text-indigo-900 underline decoration-indigo-600/40" {...props} />,
              ...
              blockquote: (props) => (
                <blockquote className="border-l-4 border-indigo-700 pl-4 italic text-ink-muted" {...props} />
              ),
              code: (props) => <code className="text-teal-700" {...props} />,
              pre: (props) => (
                <pre className="bg-paper border border-ink/20 rounded-lg p-4 overflow-x-auto" {...props} />
              ),
