...
<Callout type="success" title="Data Security:">
  Door een LLM lokaal uit te voeren met tools zoals **Ollama**, blijven gevoelige gegevens binnen de
  infrastructuur van de organisatie – zonder externe blootstelling.
</Callout>
...
<Callout type="info" title="Source Code">
  The entire source code is on my{" "}
