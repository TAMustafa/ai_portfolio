        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-white border border-border rounded-lg py-3 px-4 text-ink placeholder-ink/50 focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
          </div>
          <div>
          ...
          <button
            ...
            className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 disabled:bg-ink/30"
          >
