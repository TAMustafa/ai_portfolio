...
const SocialLink = ({
  ...
  <motion.a
    ...
    className="flex items-center gap-3 text-lg muted hover:text-teal-700 transition-colors duration-300"
    ...
    >
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          <p className="text-lg muted max-w-xl mb-8 leading-relaxed">{t("about.subtitle")}</p>
          <div className="flex justify-center md:justify-start items-center gap-6 md:gap-8 flex-wrap">
            <SocialLink href="/resume.pdf" icon={FileText} label={t("about.resume_cta")} />
            <SocialLink href={t("about.socials.github")} icon={Github} label="GitHub" />
            <SocialLink href={t("about.socials.linkedin")} icon={Linkedin} label="LinkedIn" />
          </div>
        </motion.div>
      </div>
    </section>
